...
Redis is bound to `127.0.0.1:46379`, requires a password, and persists data in the
...
local machine at `http://127.0.0.1:45540`. On the first visit, accept RedisInsight's
...
needed, use host `redis`, port `46379`, and the local Redis password from
